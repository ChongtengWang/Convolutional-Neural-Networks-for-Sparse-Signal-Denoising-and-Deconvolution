function y = CNN(input, denoiser_CNN)
   ...
   elseif length(denoiser_CNN) == 7
           y = CNN_5hiddenlayer(input, denoiser_CNN{1},denoiser_CNN{2},denoiser_CNN{3},denoiser_CNN{4},denoiser_CNN{5},denoiser_CNN{6},denoiser_CNN{7});
   end
